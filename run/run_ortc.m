function [X_recov,RSE,RMSE,R2,time] = run_ortc(X_0,C_0,Omega_tra,Omega_val,Omega_tst,rank,lambda_,transform)
loop = 1;
lambda_1 = 0.01;
dim_ = size(X_0);
...
for i = 1:length(lambda_)
    [X_recov,~,~] = ortc(M_0,Omega_tra,rank,loop,lambda_1,lambda_(i),transform);
...
[X_recov,~,time] = ortc(M_0,Omega_tra,rank,loop,lambda_1,lambda_opt,transform);
